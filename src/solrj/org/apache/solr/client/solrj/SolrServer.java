...
/**
 * @version $Id: SolrServer.java 824332 2009-10-12 13:40:03Z ehatcher $
 * @since solr 1.3
 */
public abstract class SolrServer implements Serializable
{
  ...
  public UpdateResponse deleteById(List<String> ids, boolean updateStore) throws SolrServerException, IOException {
	  UpdateRequest req = new UpdateRequest().deleteById(ids);
	  req.setUpdateStore(updateStore);
	  return req.process( this );
  }
