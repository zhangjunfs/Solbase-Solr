...
public class BinaryUpdateRequestHandler extends ContentStreamHandlerBase {
  ...
  private void parseAndLoadDocs(SolrQueryRequest req, SolrQueryResponse rsp, InputStream stream,
    ...
    if (update.getDeleteById() != null) {
      delete(update.getDeleteById(), processor, true, params);
    }
    if (update.getDeleteQuery() != null) {
      delete(update.getDeleteQuery(), processor, false, params);
    }
  ...
  private void delete(List<String> l, UpdateRequestProcessor processor, boolean isId, SolrParams params) throws IOException {
    ...
    for (String s : l) {
      ...
      if(updateStore != null){
    	  delcmd.setUpdateStore(updateStore.booleanValue());
      }
  ...
  public String getSource() {
    return "$URL: https://svn.apache.org/repos/asf/lucene/solr/branches/branch-1.4/src/java/org/apache/solr/handler/BinaryUpdateRequestHandler.java $";
  }
