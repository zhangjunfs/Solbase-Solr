...
class XMLLoader extends ContentStreamLoader {
  ...
  public void load(SolrQueryRequest req, SolrQueryResponse rsp, ContentStream stream) throws Exception {
    ...
    try {
      ...
      this.processUpdate(processor, parser, req.getParams());
    }
   ...
   * @since solr 1.2
   */
  void processUpdate(UpdateRequestProcessor processor, XMLStreamReader parser, SolrParams solrParams)
   ...
   * @since solr 1.3
   */
  void processDelete(UpdateRequestProcessor processor, XMLStreamReader parser, SolrParams params) throws XMLStreamException, IOException {
    // Parse the command
